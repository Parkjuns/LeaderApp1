//
//  DailyReportStaticsDetail.swift
//  LeaderApp
//
//  Created by leaders on 2023/05/22.
//  일일배당 및 미결(세부내역)
...
struct DailyReportStaticsDetail : View {
              ...
              if showDatePicker {
                  DatePicker(
                      ...
                      .onChange(of: selectedDate) { _ in
                          dailyReportVM.getDailyReportStaticContent(report_date: "\(formattedReportDate)", work: 60, part: 1)
                      }
              }
...
//                  }
        ...
        .onAppear(perform: {dailyReportVM.getDailyReportStaticContent(report_date: "\(formattedReportDate)", work: 60, part: 1)}) //뷰가 화면에 나타났을때 실행
...
struct DailyReportStaticsDetail_Previews: PreviewProvider {
